...
def gen_summary_by_entity_pmid(kb,evidence_id_list,target):
    ...
    if (odds_sorted or cre_sorted or ore_sorted):
        ...
        if odds_sorted:
            ...
            ## html version
            sent10 = "The odds ratio found between " + "<span style='color:#3dc904;font-weight:bold'>"+ html.escape(mention1) + " and " + html.escape(mention2)+ "</span>"+ " is " + "<mark style='background-color:bcf7a4'>" + html.escape(str(odds_sorted["annotation"][0])) + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2]))+ ")." +"</mark>" +" "
            sent20 = "<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention1) + " and " + html.escape(mention2) + "</span>"+ " have an " + "<mark style='background-color:hsv(103, 16%, 98%)'>" + html.escape(str(odds_sorted["annotation"][0]))  + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2])) + ")"+" odds ratio." +"</mark>" +" "
        ...
        if cre_sorted:
            ...
            if cre_sorted["annotation"][0]=="Cause-associated":
                ...
                ## html
                sent10="We believe that there is a " +  "<mark style='background-color:#c4d2f5'>" + "causal relationship" +"</mark>"+" between " +  "<span style='color:#4173f0;font-weight:bold'>" + str(mention1) +" and " + str(mention2) + "</span>" + " "+ "<mark style='background-color:#c4d2f5'>"+ "with a confidence of " + '{}'.format(cre_sorted["annotation"][1])+"</mark>" + ". "+ "Here is an excerpt of the literature (PMID: " +str(cre_sorted["pmid"])+") " + 'that captures the relations: "' + cre_sorted["sentence"] +'" '
                sent20= "With a " + "<mark style='background-color:#c4d2f5'>"+ "confidence of " + '{}'.format(cre_sorted["annotation"][1])+ "</mark>" +", we found that " +  "<span style='color:#4173f0;font-weight:bold'>" + str(mention1)  + "</span>"+ " is " +  "<mark style='background-color:#c4d2f5'>" + "a causal variant of" +"</mark>"+ " " +  "<span style='color:#4173f0;font-weight:bold'>" + str(mention2)  + "</span>" + ". " + "This piece of relation is evidenced by the sentence in PMID " + str(cre_sorted["pmid"]) + ': "'+cre_sorted["sentence"] + '" '
                sent30= "Based on the sentence (PMID: " +str(cre_sorted["pmid"])+") "+ ': "'+ cre_sorted["sentence"] + '" Our finding indicates that ' +  "<span style='color:#4173f0;font-weight:bold'>" + str(mention1) + "</span>" + " is associated with " +  "<span style='color:#4173f0;font-weight:bold'>" + str(mention2) +  "</span>" + " "+ "<mark style='background-color:#c4d2f5'>" + "by a confidence of "+'{}'.format(cre_sorted["annotation"][1])+"</mark>" + ". "
            if cre_sorted["annotation"][0]=="In-patient":
                ...
                ## html
                sent10 = "<span style='color:#4173f0;font-weight:bold'>"+html.escape(mention1)+ "</span>" + " " +"<span style='color:#4173f0;font-weight:bold'>"+"occurs" +"</span>" + " in some " + "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention2) + " patients." "</span>" +" Our finidng shows that " + "<mark style='background-color:#c4d2f5'>"  +"the confidence of this association is approximately " + html.escape('{}'.format(cre_sorted["annotation"][1]))+"." + "</mark>" + "Here is an excerpt of the literature (PMID: " +html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' + html.escape(cre_sorted["sentence"]) +'" '
                sent20 = "With a " +"<mark style='background-color:#c4d2f5'>"+ "confidence of " + html.escape('{}'.format(cre_sorted["annotation"][1]))+ "</mark>" + ", we found that " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1)+" patients"+ "</span>" + " " +"carry" + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2) +"."+ "</span>" + "This piece of relation is evidenced by the sentence in PMID" + html.escape(str(cre_sorted["pmid"])) + ': "'+html.escape(cre_sorted["sentence"]) + '" '
                sent30 = 'As claimed by "'+ html.escape(cre_sorted["sentence"]) +'" ' + "we are " + "<mark style='background-color:#c4d2f5'>"+ html.escape('{}'.format(cre_sorted["annotation"][1]))+ ""+ " sure" + "</mark>" + " that " +  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2)+" patients" + "</mark>" +" show to have " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1) + "." + "</mark>" + " "
            if cre_sorted["annotation"][0]=="Appositive":
                ...
                ## html
                sent10 = "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1)+ "'s relation with " + "<span style='color:#4173f0;font-weight:bold'>"+html.escape(mention2) + " is " + "<mark style='background-color:#c4d2f5'>"+ "presupposed." + "</mark>"+ " We are " +  "<mark style='background-color:#c4d2f5'>" + html.escape('{}'.format(cre_sorted["annotation"][1]))+ " " + "confidence" + "</mark>" +" about this association. " + "Here is an excerpt of the literature (PMID:" +html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' + html.escape(cre_sorted["sentence"]) +'" '
                sent20 = "It is " + html.escape('{}'.format(cre_sorted["annotation"][1])) +" "+   "<mark style='background-color:#c4d2f5'>" + "presupposed" + "</mark>" +" that " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1) +"</mark>" + " is related to "+"<mark style='background-color:#c4d2f5'>"+ html.escape(mention2) + "</mark>" + ' as evidenced by "' + html.escape(cre_sorted["sentence"]) + "' (PMID: "+ html.escape(str(cre_sorted["pmid"]))+'." '
                sent30 = 'According to the sentence: "' + html.escape(cre_sorted["sentence"])+ "' (PMID: " + html.escape(str(cre_sorted["pmid"]))+ ") " + "The relation between " + "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention1) +"</mark>" +" and " + html.escape(mention2) + " contains a " +   "<mark style='background-color:#c4d2f5'>" + "presupposition." + "</mark>" +" "
        ...
        if ore_sorted:
            ...
            if len(ore_sorted)==2:
                ...
                ## html
                sent10="Moreover, there are also other relations found, which includes the following: " + "<span style='color:#f75282;font-weight:bold'>"+ str(mention1) + "</span>" + " & " + "<span style='color:#f75282;font-weight:bold'>"+str(mention2)  +  "</span>" + " and " + "<span style='color:#4173f0;font-weight:bold'>" + str(mention3) + "</span>" +" & " +  "<span style='color:#4173f0;font-weight:bold'>"+str(mention4) +"</span>" + ". " + "<mark style='background-color:#f7d2dc'>" + ' "'+ str(relation1) + '."' + "</mark>" + " and " + "<mark style='background-color:#f7d2dc'>"+'"' + str(relation2) + '."' +  "</mark>"  + " "
                sent20="Notably, further relations between the aforementioned entities are discovered. " + "<mark style='background-color:#f7d2dc'>" + '"' + str(relation1) + '."' + "</mark>" + " " + "<mark style='background-color:#f7d2dc'>" + '"' + html.escape(str(relation1)) + '."' + "</mark>" + " "
                sent30= "<span style='color:#f75282;font-weight:bold'>" + html.escape(str(mention1)) + "</span>" + " & " + "<span style='color:##E2903A;font-weight:bold'>"+ html.escape(str(mention2)) + "</span>" + " and " + "<span style='color:#f75282;font-weight:bold'>"+ html.escape(str(mention3)) +  "</span>"  + " & " + "<span style='color:#f75282;font-weight:bold'>" + html.escape(str(mention4)) + "</span>" + ' also contain further relations. ' + "<mark style='background-color:#f7d2dc'>"+ '"'+ html.escape(str(relation1)) + '."' + "</mark>" + " and " + "<mark style='background-color:#f7d2dc'>" + html.escape(str(relation2)) +'."' + "</mark>" + " "
            else:
                ...
                sent20 ="<mark style='background-color:#f7d2dc'>" + '"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '"' + "." + "</mark>" + " "
                sent30 ="In addition, " +"<mark style='background-color:#f7d2dc'>"+'"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '"' + "."+ "</mark>" + " "
        ...
        ## html intro
        sent10=  "Based on our search results, in PMID: " + "<b>" +html.escape(target[2]) +"</b>"+ ", relation exists between " +  "<b>" + html.escape(mention1) +  "</b>" +" and these prominent mentions: " + html.escape(final_combine) + ". "
        sent20= "From PMID: " +"<b>"+ html.escape(target[2])+"</b>" + ", " + "<b>"+html.escape(mention1) +"</b>"+ " relates to "  + html.escape(final_combine) + ". "
        sent30= "We found that these mentions-" + html.escape(final_combine)+ "-" + "relate(s) to " +"<b>"+ html.escape(mention1) + "</b>" +" in PMID: " +"<b>"+html.escape(target[2]) + "</b>" + "." + ' '
...
def gen_summary_by_entity(kb,evidence_id_list,target):
    ...
    if (odds_sorted or cre_sorted or ore_sorted):
        ...
        if odds_sorted:
            ...
            ## html
            sent10="The odds ratio found between " + "<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention1) + "</span>" + " and " +"<span style='color:#3dc904;font-weight:bold'>"+ html.escape(mention2) +"</span>"+ " in PMID: " + html.escape(str(odds_sorted["pmid"])) + " is " + "<mark style='background-color:#bcf7a4'>" + html.escape(str(odds_sorted["annotation"][0])) + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2]))+ ")." + "</mark>" + " "
            sent20= "<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention1)+ " and " + mention2 + "</span>" + " have an " + "<mark style='background-color:#bcf7a4'>" + str(odds_sorted["annotation"][0])  + " (CI: " + str(odds_sorted["annotation"][1]) + ", p-value: "+  str(odds_sorted["annotation"][2]) + ")"+" odds ratio" + "</mark>"+  " (PMID: " + str(odds_sorted["pmid"]) + ")."  +" "
            odds_list=[sent1,sent2]
            combined_mentions.add(mention2)
            odds_list=random.choice(odds_list)
            odds_list2=[sent10,sent20]
        ...
        if cre_sorted:
            ...
            if cre_sorted["annotation"][0]=="Cause-associated":
                ...
                sent3= "Based on the sentence (PMID: " +str(cre_sorted["pmid"])+") "+ ': "'+ cre_sorted["sentence"] + '" Our finding indicates that ' + str(mention1) + " is associated with " + str(mention2) + " by a confidence of "+'{}'.format(cre_sorted["annotation"][1])+ ". "
                ##html
                sent10 ="We believe that there is a " + "<mark style='background-color:#c4d2f5'>" + "causal relationship" + "</mark>" +  " between " +  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + "</span>" +" and " + "<span style='color:#4173f0;font-weight:bold'>"+html.escape(str(mention2))+ "</span>"+ " with a " + "<mark style='background-color:#c4d2f5'>"+ "confidence of " + html.escape('{}'.format(cre_sorted["annotation"][1]))+ "." + "</mark>" + " Here is an excerpt of the literature (PMID: " +html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' + html.escape(cre_sorted["sentence"]) +'" '
                sent20 = "With a " +"<mark style='background-color:#c4d2f5'>"+"confidence of " + html.escape('{}'.format(cre_sorted["annotation"][1]))+"</mark>" + ", we found that " + "<span style='color:#4173f0;font-weight:bold'>" + str(mention1) + "</span>" + " is a " + "<mark style='background-color:#c4d2f5'>" + "causal variant" + "</mark>" + " of " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2)) +"</span>" + ". " + "This piece of relation is evidenced by the sentence in PMID " + html.escape(str(cre_sorted["pmid"])) + ': "'+html.escape(cre_sorted["sentence"]) + '" '
                sent30 = "Based on the sentence (PMID: " +html.escape(str(cre_sorted["pmid"]))+") "+ ': "'+ html.escape(cre_sorted["sentence"]) + '" Our finding indicates that ' + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + "</span>" + " is " + "<mark style='background-color:#c4d2f5'>" + "associated with" + "</mark>" " " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2)) +"</span>" + " by a " + "<mark style='background-color:#c4d2f5'>"+" confidence of "+html.escape('{}'.format(cre_sorted["annotation"][1]))+ "." + "</mark>" + " "
            if cre_sorted["annotation"][0]=="In-patient":
                sent1= mention1+ " occurs in some " + mention2 + " patients." " Our finidng shows that the confidence of this association is approximately " + '{}'.format(cre_sorted["annotation"][1])+". "+ "Here is an excerpt of the literature (PMID:" +str(cre_sorted["pmid"])+") " + 'that captures the relations: "' + cre_sorted["sentence"] +'" '
                sent2= "With a confidence of " + '{}'.format(cre_sorted["annotation"][1])+ ", we found that " + mention1+" patients "+ "carry " + mention2 +"." "This piece of relation is evidenced by the sentence in PMID" + str(cre_sorted["pmid"]) + ': "'+cre_sorted["sentence"] + '" '
                sent3= 'As claimed by "'+ cre_sorted["sentence"] +'" ' + '{}'.format(cre_sorted["annotation"][1])+ ""+ " sure that " + mention2+" patients show to have " + mention1 + ". "
                ## html
                sent10 = "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + " " +"</span>" +"<mark style='background-color:#c4d2f5'>" + "occurs" + "</mark>" + " in some " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2)) + " patients." +"</span>"+ " Our finidng shows that the " + "<mark style='background-color:#c4d2f5'>"+ " confidence of this association is approximately " + html.escape('{}'.format(cre_sorted["annotation"][1]))+"." + "</mark>"+ " Here is an excerpt of the literature (PMID:" +html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' + html.escape(cre_sorted["sentence"]) +'" '
                sent20 = "With a " + "<mark style='background-color:#c4d2f5'>" + "confidence of " + html.escape('{}'.format(cre_sorted["annotation"][1]))+ "</mark>"+ ", we found that " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1))+"</span>" +" " + "<mark style='background-color:#c4d2f5'>" +"patients" + " carry" + "</mark>" + " "+ "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2)) +"." +"</span>" + "This piece of relation is evidenced by the sentence in PMID" + html.escape(str(cre_sorted["pmid"])) + ': "'+ html.escape(cre_sorted["sentence"]) + '" '
                sent30 = 'As claimed by "'+ html.escape(cre_sorted["sentence"]) +'" ' + "we are " + "<mark style='background-color:#c4d2f5'>"+ html.escape('{}'.format(cre_sorted["annotation"][1]))+ ""+ " sure" +"</mark>" +" that " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1))+" patients " + "</span>" +  " show to have " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1) + "." + "</span>" + " "
            if cre_sorted["annotation"][0]=="Appositive":
                ...
                sent3= 'According to the sentence: "' + cre_sorted["sentence"]+ "' (PMID: " + str(cre_sorted["pmid"])+") " + "The relation between " + mention1 + " and " + mention2 + " contains a presupposition."
                ## html
                sent10= "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1))+ "'s"+ "</span>"+" relation with " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2)) + "</span>" + "is " + "<mark style='background-color:#c4d2f5'>" + "presupposed." + "</mark>" + " We are " + "<mark style='background-color:#c4d2f5'>" + html.escape('{}'.format(cre_sorted["annotation"][1]))+ " " + "confident" + "</mark>" + " about this association. " + "Here is an excerpt of the literature (PMID:" + html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' + html.escape(cre_sorted["sentence"]) +'" '
                sent20= "It is " + "<mark style='background-color:#c4d2f5'>" + html.escape('{}'.format(cre_sorted["annotation"][1])) +  " presupposed" + "</mark>" + " that "+  "<span style='color:#4173f0;font-weight:bold'>"  + html.escape(str(mention1)) + "</span>" + " is related to "+ "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(str(mention2)) + "</spam>"+' as evidenced by "' + cre_sorted["sentence"] + "' (PMID: "+ html.escape(str(cre_sorted["pmid"]))+'." '
                sent30= 'According to the sentence: "' + cre_sorted["sentence"]+ "' (PMID: " + str(cre_sorted["pmid"])+") " + "The relation between " + "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(str(mention1)) +  "</span>" + " and " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2)) + "</span>"+ " contains a " + "<mark style='background-color:#c4d2f5'>" +"presupposition." + "</mark>" + " "
            rbert_list=[sent1,sent2,sent3]
            rbert_list=random.choice(rbert_list)
            rbert_list2=[sent10,sent20,sent30]
            rbert_list2=random.choice(rbert_list2)
        if ore_sorted:
            ...
            if len(ore_sorted)==2:
                ...
                ## html
                sent10 ="Moreover, there are also other relations found, which includes the following: " + "<span style='color:#f75282;font-weight:bold'>" + html.escape(str(mention1))  + " & "  + html.escape(str(mention2))  +"</span>" +" and " + "<span style='color:#f75282;font-weight:bold'>" + html.escape(str(mention3)) +' & ' + html.escape(str(mention4)) + '. ' + "</span>" + " " + "<mark style='background-color:#f7d2dc'>"+ '"'+ str(relation1) + '" (PMID: ' +  ore_sorted[0]["pmid"]+ ')' + "</mark>" + ' and ' + "<mark style='background-color:#f7d2dc'>"+'"' + str(relation2) + '" (PMID: ' +  ore_sorted[1]["pmid"]+').' +"</mark>" + " "
                sent20 ='Notably, further relations between the aforementioned entities are discovered. ' + "<span style='color:#f75282;font-weight:bold'>" + html.escape(str(mention1))  +  " & " + html.escape(str(mention2))  +"</span>"+ " and " + "<span style='color:#f75282;font-weight:bold'>" + html.escape(str(mention3)) + ' & '  + html.escape(str(mention4)) + '. ' +"</span>"+ ""  +"<mark style='background-color:#f7d2dc'>"+ '"'+ str(relation1) + '" (PMID: ' +  ore_sorted[0]["pmid"]+ ')' + "</mark>" + ' and ' + "<mark style='background-color:#f7d2dc'>"+'"' + str(relation2) + '" (PMID: ' +  ore_sorted[1]["pmid"]+').' +"</mark>" + " "
                sent30 = "<span style='color:#f75282;font-weight:bold'>"+html.escape(str(mention1)) +  " & " + html.escape(str(mention2))  + "</span>" + " and " + "<span style='color:#f75282;font-weight:bold'>" + html.escape(str(mention3)) + " & " + html.escape(str(mention4))+ "</span>" + ' also contain further relations. '+ "<mark style='background-color:#f7d2dc'>"+ '"'+ html.escape(str(relation1)) + '" (PMID: ' +  ore_sorted[0]["pmid"]+ ')' + "</mark>" + ' and ' + "<mark style='background-color:#f7d2dc'>"+'"' + str(relation2) + '" (PMID: ' +  ore_sorted[1]["pmid"]+').' +"</mark>" + " "
            else:
                ...
                ## html
                sent10 ='We also found' + "<mark style='background-color:#f7d2dc'>" + '"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '" (PMID: ' +  ore_sorted[0]["pmid"] + ")." + "</mark>" + " "
                sent20 ="<mark style='background-color:#f7d2dc'>" + '"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '" (PMID: ' +  ore_sorted[0]["pmid"] + ")." + "</mark>" + " "
                sent30 ="In addition, " + "<mark style='background-color:#f7d2dc'>" +'"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '" (PMID: ' +  ore_sorted[0]["pmid"] + ")." + "</mark>" + " "
            triplet_list=[sent1,sent2,sent3]
            triplet_list=random.choice(triplet_list)
            triplet_list2=[sent10,sent20,sent30]
            triplet_list2=random.choice(triplet_list2)
        ...
        ## html
        sent10="Based on our search results, relation exists between " + "<b>" + html.escape(mention1) +"</b>" + " and these prominent mentions: " +  "<span style='color:#e05e2b;font-weight:bold'>" +html.escape(final_combine) + "</span>" + ". "
        sent20= "<b>" + html.escape(mention1) + "</b>"+" relates to "  + "<span style='color:#e05e2b;font-weight:bold'>"+ html.escape(final_combine) + "</span>"+ ". "
        sent30= "We found that these mentions-" + "<span style='color:#e05e2b;font-weight:bold'>" + html.escape(final_combine) + "</span>"+"-" + "relate(s) to " +"<b>"+ html.escape(mention1) + "</b>"  + ". "
        intro_list=[sent1,sent2, sent3]
        intro_list=random.choice(intro_list)
        intro_list2=[sent10,sent20, sent30]
        intro_list2=random.choice(intro_list2)
...
def gen_summary_by_pair(kb,evidence_id_list,target):
    ...
    if (odds_sorted or cre_sorted or ore_sorted):
        ...
        if odds_sorted:
            ...
            sent2 = mention1+ " and " + mention2 + " have an " + str(odds_sorted["annotation"][0])  + " (CI: " + str(odds_sorted["annotation"][1]) + ", p-value: "+  str(odds_sorted["annotation"][2]) + ")"+" odds ratio (PMID: " + str(odds_sorted["pmid"]) + "). "
            sent10 = "The odds ratio found between " + "<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention1) + "</span>" + " and " + "<span style='color:#3dc904;font-weight:bold'>"+ html.escape(mention2)+ "</span>"+ " in PMID: " + html.escape(str(odds_sorted["pmid"])) + " is " + "<mark style='background-color:#bcf7a4'>" + html.escape(str(odds_sorted["annotation"][0])) + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2]))+ ")." + "</mark>" + " "
            sent20 = "<span style='color:#3dc904;font-weight:bold'>"+ html.escape(mention1)+ "</span>" +" and " + "<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention2) +"</span>" + " have an " + "<mark style='background-color:#bcf7a4'>" + html.escape(str(odds_sorted["annotation"][0]))  + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2])) + ")"+" odds ratio"  + "</mark>" + " (PMID: " + html.escape(str(odds_sorted["pmid"])) + "). "
            odds_list = [sent1,sent2]
            odds_list = random.choice(odds_list)
            odds_list2 = [sent10,sent20]
            odds_list2 = random.choice(odds_list2)
        if cre_sorted:
            ...
            if cre_sorted["annotation"][0]=="Cause-associated":
                sent1="We believe that there is a causal relationship between " + str(mention1) + " and " + str(mention2)+ " with a confidence of " + '{}'.format(cre_sorted["annotation"][1])+ ". "+ "Here is an excerpt of the literature (PMID: " +str(cre_sorted["pmid"])+")" + ' that captures the relations: ' + '"' + cre_sorted["sentence"] + '"' + "."
                sent2= "With a confidence of " + '{}'.format(cre_sorted["annotation"][1])+ ", we found that " + str(mention1)  + " is a causal variant of " + str(mention2)  + ". " + "This piece of relation is evidenced by the sentence in PMID " + str(cre_sorted["pmid"]) + ': "'+cre_sorted["sentence"] + '" '
                sent3= "Based on the sentence (PMID: " +str(cre_sorted["pmid"])+") "+ ': "'+ cre_sorted["sentence"] + '" Our finding indicates that ' + str(mention1) + " is " + "<mark style='background-color:#c4d2f5'>" + "associated with" + "</mark>" + " " + str(mention2) + " by a confidence of "+'{}'.format(cre_sorted["annotation"][1])+ ". "
                ## html ##
                sent10="We believe that there is a " +"<mark style='background-color:#c4d2f5'>"+  "causal relationship" + "</mark>" + " between " + "<span style='color:#4173f0;font-weight:bold'>"  + html.escape(str(mention1)) +"</span>" +" and " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2))+"</span>" + " with a " + "<mark style='background-color:#c4d2f5'>" + "confidence of " + '{}'.format(cre_sorted["annotation"][1])+ "."+ "</mark>" + " Here is an excerpt of the literature (PMID: " + html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' +  html.escape(cre_sorted["sentence"]) +'" '
                sent20= "With a " + "<mark style='background-color:#c4d2f5'>" + "confidence of " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+"</mark>" +", we found that " +  "<span style='color:#4173f0;font-weight:bold'>" + str(mention1) +"</span>"  + " is a " + "<mark style='background-color:#c4d2f5'>"+ "causal variant"  + "</mark>" +" of " +  "<span style='color:#4173f0;font-weight:bold'>"  + html.escape(str(mention2)) + "</span>" + ". " + "This piece of relation is evidenced by the sentence in PMID " +  html.escape(str(cre_sorted["pmid"])) + ': "'+ html.escape(cre_sorted["sentence"]) + '" '
                sent30= "Based on the sentence (PMID: " + html.escape(str(cre_sorted["pmid"]))+") "+ ': "'+  html.escape(cre_sorted["sentence"]) + '" Our finding indicates that ' +  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + "</span>" +  " is " + "<mark style='background-color:#c4d2f5'>" + "associated with" + "</mark>"  + " "  +  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2)) + "</span>"  + " by a " + "<mark style='background-color:#c4d2f5'>"+ "confidence of "+ html.escape('{}'.format(cre_sorted["annotation"][1]))+ "." + "</mark>" + " "
            ...
            if cre_sorted["annotation"][0]=="In-patient":
                ...
                ## html ##
                sent10=  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1))+ "</span>" + " "+"<mark style='background-color:#c4d2f5'>"+ "occurs in" + "</mark>" + " some " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2))+" " + "</span>"  + "<mark style='background-color:#c4d2f5'>" + "patients." + "</mark>" + " Our finding shows that the confidence of this association is approximately " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+". "+ "Here is an excerpt of the literature (PMID:" +str(cre_sorted["pmid"])+") " + 'that captures the relations: "' + cre_sorted["sentence"] +'" '
                sent20= "With a " + "<mark style='background-color:#c4d2f5'>"+ "confidence of " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+ "</mark>" + ", we found that " +  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + " "+ "</span>"   +"<mark style='background-color:#c4d2f5'>" + "patients" +" carry" + "</mark>"  +  "<span style='color:#4173f0;font-weight:bold'>" +" " +html.escape(str(mention2)) + "</span>" +". " "This piece of relation is evidenced by the following sentence in (PMID: " + str(cre_sorted["pmid"]) + '). "' +cre_sorted["sentence"] + '" '
                sent30= 'As claimed by "'+ html.escape(cre_sorted["sentence"]) +'" PMID: (' + html.escape(str(cre_sorted["pmid"]))+"), we are " + "<mark style='background-color:#c4d2f5'>" + '{}'.format(cre_sorted["annotation"][1])+ ""+ " sure" + "</mark>"+ " that " +  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2))+ "</span>"  + " " +"<mark style='background-color:#c4d2f5'>"+ "patients "  + "show to have" +"</mark>"+ " "+  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) +"</span>"  +". "
            if cre_sorted["annotation"][0]=="Appositive":
                sent1= mention1+ "'s relation with " + mention2 + "is presupposed." + " We are " + '{}'.format(cre_sorted["annotation"][1])+ " " + "confidence about this association. " + "Here is an excerpt of the literature (PMID:" +str(cre_sorted["pmid"])+") " + 'that captures the relations: "' + cre_sorted["sentence"] +'" '
                sent2= "It is " +  '{}'.format(cre_sorted["annotation"][1])+" "+  "presupposed that "+ mention1 + " is related to "+ mention2 + " as evidenced by '" + cre_sorted["sentence"] + "' (PMID: "+str(cre_sorted["pmid"])+". "
                sent3= 'According to the sentence: "' + cre_sorted["sentence"]+ '" (PMID: ' + str(cre_sorted["pmid"])+") " + "The relation between " + mention1 + " and " + mention2 + " contains a presupposition. "
                ## html ##
                sent10 =  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1))+ "</span>"  +"'s relation with " + "<span style='color:#4173f0;font-weight:bold'>"  +  html.escape(str(mention2)) +"</span>" + "is "+ "<mark style='background-color:#c4d2f5'>" + "presupposed."  + "</marl>"+ " We are " +  "<mark style='background-color:#c4d2f5'>" + html.escape('{}'.format(cre_sorted["annotation"][1]))+ " " + "confidence" +"</mark>" +" about this association. " + "Here is an excerpt of the literature (PMID:" + html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' +  html.escape(cre_sorted["sentence"]) +'" '
                sent20 = "It is " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+" "+  "<mark style='background-color:#c4d2f5'>" + "presupposed"+ "</mark>"+" that "+  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + "</span>" + " is related to "+  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2)) + "</span>" +" as evidenced by '" +  html.escape(cre_sorted["sentence"]) + "' (PMID: "+  html.escape(str(cre_sorted["pmid"]))+". "
                sent30 = 'According to the sentence: "' +  html.escape(cre_sorted["sentence"])+ '" (PMID: ' +  html.escape(str(cre_sorted["pmid"]))+") " + "The relation between " +  "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + "</span>" +" and "+ "<span style='color:#4173f0;font-weight:bold'>"  + html.escape(str(mention2)) +"</span>" + " contains a" + "<mark style='background-color:#c4d2f5'>"+"presupposition." + "</mark>" + " "
            rbert_list=[sent1,sent2,sent3]
            rbert_list=random.choice(rbert_list)
            rbert_list2=[sent10,sent20,sent30]
            rbert_list2=random.choice(rbert_list2)
        if ore_sorted:
            if len(ore_sorted)==2:
                ...
                ## html
                sent10='Moreover, there are also relations found between these two entities, which includes the following. ' +"<mark style='background-color:#f7d2dc'>"+ '"' + html.escape(relation1) + '" (PMID: ' + html.escape(ore_sorted[0]["pmid"]) +')."' + "</mark>" + " " +"<mark style='background-color:#f7d2dc'>"+'"'+ html.escape(relation2)+ '" (PMID: ' + html.escape(ore_sorted[1]["pmid"]) +').' + "</mark>" + " "
                sent20='Notably, further relations between ' + "<span style='color:#f75282;font-weight:bold'>" + html.escape(mention1) +"</span>" + " and " + "<span style='color:#f75282;font-weight:bold'>" + html.escape(mention2)  +"</span>"+  ' are present. '+  "<mark style='background-color:#f7d2dc'>" +'"' + html.escape(relation1) + '" (PMID: ' + html.escape(ore_sorted[0]["pmid"]) +')."' +"</mark>" + "<mark style='background-color:#f7d2dc'>" + '"'+html.escape(relation2)+ '" (PMID: ' + html.escape(ore_sorted[1]["pmid"]) +').' + "</mark>"+" "
                sent30= 'Between these two entities, prior literature also entails that ' +  "<mark style='background-color:#f7d2dc'>" + '"'+html.escape(relation1) + '" (PMID: ' + html.escape(ore_sorted[0]["pmid"]) +')'+ "</mark>" + ' and "' +"<mark style='background-color:#f7d2dc'>"+ '"'+html.escape(relation2)+ '" (PMID: ' + html.escape(ore_sorted[1]["pmid"]) +').' +"</mark>" + " "
                ...
                ## html
                sent10='We also found ' + "<mark style='background-color:#f7d2dc'>"+'"' + html.escape(' '.join(ore_sorted[0]["annotation"])) + '" (PMID: ' +  html.escape(ore_sorted[0]["pmid"]) + "." + "</mark>" +" "
                sent20="<mark style='background-color:#f7d2dc'>"+'"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '" (PMID: ' +  html.escape(ore_sorted[0]["pmid"])+ "</mark>" +" "
                sent30="In addition, " +"<mark style='background-color:#f7d2dc'>"+'"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '" (PMID: ' +  html.escape(ore_sorted[0]["pmid"]) + "." + "</mark>" +" "
...
def gen_summary_by_pmid(kb,evidence_id_list,target):
    ...
    if (odds_sorted or cre_sorted or ore_sorted):
        if odds_sorted:
            ...
            ## html
            sent10="The odds ratio found between " +"<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention1) + "</span>" +" and " + "<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention2) +"</span>" + " in PMID: " + html.escape(str(odds_sorted["pmid"])) + " is " + "<mark style='background-color:#bcf7a4'>" + html.escape(str(odds_sorted["annotation"][0])) + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2]))+ ")." + "</mark>" + " "
            sent20="<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention1) + "</span>" +" and " + "<span style='color:#3dc904;font-weight:bold'>" + html.escape(mention2)  + "</span>" +" have an " + "<mark style='background-color:#bcf7a4'>" + str(odds_sorted["annotation"][0])  + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2])) + ")"+" odds ratio" + "</mark>" + ". "
            odds_list2=[sent10,sent20]
            odds_list2=random.choice(odds_list2)
        if cre_sorted:
            mention1=cre_sorted["head"][2]
            ...
            ## html
                sent10="We believe that there is a " + "<mark style='background-color:#c4d2f5'>"+ "causal relationship" + "</mark>"  + " between " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + "</span>" +" and " + "<span style='color:#4173f0;font-weight:bold'>"  +html.escape(str(mention2)) +"</span>" + " with a " + "<mark style='background-color:#c4d2f5'>" + "confidence of " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+ "." + "</mark>"+ " " + "Here is an excerpt of the literature (PMID: " + html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' +  html.escape(cre_sorted["sentence"]) +'" '
                sent20= "With a " + "<mark style='background-color:#c4d2f5'>" + "confidence of " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+ "</mark>"  +", we found that " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1))  + "</span>"  + " is a " + "<mark style='background-color:#c4d2f5'>" "causal variant" + "</mark>" + " of " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention2))  + "</span>"  + ". " + "This piece of relation is evidenced by the sentence in PMID " +  html.escape(str(cre_sorted["pmid"])) + ': "'+ html.escape(cre_sorted["sentence"]) + '" '
                sent30= "Based on the sentence (PMID: " + html.escape(str(cre_sorted["pmid"]))+")"+ ': "'+  html.escape(cre_sorted["sentence"]) + '" Our finding indicates that ' + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + "</span>" + " is " + "<mark style='background-color:#c4d2f5'>" + "associated with" + "</mark>"+ " " +"<span style='color:#4173f0;font-weight:bold'>" +  html.escape(str(mention2))   + "</span>" + " by a " + "<mark style='background-color:#c4d2f5'>" + "confidence of "+ html.escape('{}'.format(cre_sorted["annotation"][1]))+ "." + "</mark>" + " "
            ...
            if cre_sorted["annotation"][0]=="In-patient":
                ...
                ## html
                sent10= "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1)+ "</span>" + " " +"<mark style='background-color:#c4d2f5'>"+ " "  + "occurs in" + "</mark>" +" some " + "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention2) +"</span>" +  " " +"<mark style='background-color:#c4d2f5'>"  +"patients." +  "<mark>"  +" Our finidng shows that the " + "<mark style='background-color:#c4d2f5'>"+ "confidence of this association is approximately " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+"." + "</mark>" + " " + "Here is an excerpt of the literature (PMID: " + html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' + cre_sorted["sentence"] +'" '
                sent20= "With a " +"<mark style='background-color:#c4d2f5'>"+"confidence of " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+ "</mark>"+", we found that " + "<span style='color:#4173f0;font-weight:bold'>" +  html.escape(mention1)+ "</span>" +" " +"<mark style='background-color:#c4d2f5'>" +"patients "+ "carry" + "</mark>"  +" " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2) + "</span>" +"." "This piece of relation is evidenced by the sentence in PMID" +  html.escape(str(cre_sorted["pmid"])) + ": '"+ html.escape(cre_sorted["sentence"]) + "'"
                sent30= "As claimed by '"+  html.escape(cre_sorted["sentence"]) +"' PMID: (" + html.escape(str(cre_sorted["pmid"]))+"), we are " +  html.escape('{}'.format(cre_sorted["annotation"][1]))+ " sure that " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2)+ "</span>" + " " +  "<mark style='background-color:#c4d2f5'>" + "patients show to have" + "</mark>" + " "  +"<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2) + "." + "</span>" + " "
            ...
            if cre_sorted["annotation"][0]=="Appositive":
                ...
                ## html
                sent10= "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1)+ "'s"+ "</span>" + " relation with " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2) + "</span>"  + "is " + "<mark style='background-color:#c4d2f5'>" + "presupposed."+ "</mark>" + " We are " + "<mark style='background-color:#c4d2f5'>"+html.escape('{}'.format(cre_sorted["annotation"][1]))+ " " + "confidence" + "</mark>" + " about this association. " + "Here is an excerpt of the literature (PMID:" +html.escape(str(cre_sorted["pmid"]))+") " + "that captures the relations: '" + html.escape(cre_sorted["sentence"]) +"' "
                sent20= "It is " +"<mark style='background-color:#c4d2f5'>"+ html.escape('{}'.format(cre_sorted["annotation"][1]))+ " "+  "presupposed"  +"</mark>" + "that "+ "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1) + "</span>" + " is related to "+ html.escape(mention2) + " as evidenced by '" + html.escape(cre_sorted["sentence"]) + "' (PMID: "+html.escape(str(cre_sorted["pmid"]))+". "
                sent30= "According to the sentence: '" + html.escape(cre_sorted["sentence"])+ "' (PMID: " + html.escape(str(cre_sorted["pmid"]))+") " + "The relation between " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1) + "</span>"   +" and " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2) +  "</span>"  + " contains a " +"<mark style='background-color:#c4d2f5'>"+ "presupposition." + "</mark>"  +" "
        ...
        if ore_sorted:
            ...
            if len(ore_sorted)==2:
                ...
                ## html
                sent10 ='Moreover, there are also other relations found in this PMID: ' + html.escape(target)+ ', which includes the following. "' + "<mark style='background-color:#f7d2dc'>" + html.escape(relation1) + "."  + "</mark>" + " " + "<mark style='background-color:#f7d2dc'>"  + '"'+ html.escape(relation2)+ '."'+ "</mark>" + " "
                sent20 ='Notably, in this PMID, further relations between these two entities are discovered.'+ " " +  "<mark style='background-color:#f7d2dc'>" +'"' + html.escape(relation1) + '."' +"</mark>" + " " + "<mark style='background-color:#f7d2dc'>" + '"' + html.escape(relation2)+ '."' +"</mark>" + " "
                sent30 = 'PMID: ' + html.escape(target) + ' also entails relations:' + " " +"<mark style='background-color:#f7d2dc'>"+ '"' + html.escape(relation1) + '"' +"</mark>" + " and " + "<mark style='background-color:#f7d2dc'>"+ " " +'"'+ html.escape(relation2) +'."' + "</mark>"
            else:
                mention1=ore_sorted[0]["head"][2]
                mention2=ore_sorted[0]["tail"][2]
                combined_mentions.add(mention1)
                ...
                ## html
                sent10 ='In this PMID, we also found' + " "+"<mark style='background-color:#f7d2dc'>" +'"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '."' + "</mark>" + " "
                sent20 ="<mark style='background-color:#f7d2dc'>"+ '"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '."' +"</mark>"+ " "
                sent30 ="In addition, " + "<mark style='background-color:#f7d2dc'>" +'"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '."'+ "</mark>" + " "
            triplet_list=[sent1,sent2,sent3]
            triplet_list=random.choice(triplet_list)
        ...
        ## html
        sent10= "PMID: " +"<b>" + target + "</b>" +" showcases that relations exist between these prominent mentions: " +"<span style='color:#e05e2b;font-weight:bold'>" +final_combine + "." + "</span>" + " "
        sent20= "In PMID: " + "<b>" + target +"</b>"+ ", our search results indicate that relations presented in " + "<span style='color:#e05e2b;font-weight:bold'>" + final_combine + "</span>"  +"." + " "
        sent30= "For " + "<span style='color:#e05e2b;font-weight:bold'>" + final_combine + "</span>" +  " in PMID: "+"<b>" +target +"</b>" + ", some relations are extracted. "
        intro_list=[sent1,sent2, sent3]
        intro_list=random.choice(intro_list)
        summary=list(intro_list)+list(odds_list)+list(rbert_list)+list(triplet_list)
        final_summary = ''.join(str(v) for v in summary)
...
def gen_summary_by_pmid_pair(kb,evidence_id_list,target):
    ...
    if (odds_sorted or cre_sorted or ore_sorted):
        ...
        if odds_sorted:
            ...
            odds_list=random.choice(odds_list)
            ## html
            sent10 ="The odds ratio found between " + "<span style='color:#00CE5E;font-weight:bold'>"  + html.escape(mention1) + "</span>" + " and " + "<span style='color:#00CE5E;font-weight:bold'>" + html.escape(mention2)+  "</span>"  +" is " + "<mark style='background-color:#bcf7a4'>" + html.escape(str(odds_sorted["annotation"][0])) + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2]))+ ")." + "</mark>" + " "
            sent20 ="<span style='color:#00CE5E;font-weight:bold'>"+ html.escape(mention1)+ "</span>"  +" and " +"<span style='color:#00CE5E;font-weight:bold'>" +html.escape(mention2) + "</span>"  +" have an " + "<mark style='background-color:#bcf7a4'>"  + html.escape(str(odds_sorted["annotation"][0]))  + " (CI: " + html.escape(str(odds_sorted["annotation"][1])) + ", p-value: "+  html.escape(str(odds_sorted["annotation"][2])) + ")"+" odds ratio." + "</mark>" + " "
            odds_list2=[sent10,sent20]
            odds_list2=random.choice(odds_list2)
        if cre_sorted:
            if target[0] == "type_id_name" or target[0] == "type_name":
            ...
            if cre_sorted["annotation"][0]=="Cause-associated":
                ...
                ## html
                sent10="We believe that there is a " +"<mark style='background-color:#c4d2f5'>"+ "causal relationship" + "</mark>" + " between " + "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(str(mention1))+ "</span>" +" and " + "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(str(mention2))+ "</span>" + " with " + "<mark style='background-color:#c4d2f5'>"+ "a confidence of " + html.escape('{}'.format(cre_sorted["annotation"][1]))+ "." + "</mark>" + " "+  "Here is an excerpt of the literature (PMID: " +str(cre_sorted["pmid"])+") " + 'that captures the relations: "' + cre_sorted["sentence"] +'" '
                sent20= "With a " + "<mark style='background-color:#c4d2f5'>"+ "confidence of " + html.escape('{}'.format(cre_sorted["annotation"][1]))+ "</mark>" +", we found that " +"<span style='color:#4173f0;font-weight:bold'>"+ html.escape(str(mention1)) + "</span>" + " is a " + "<mark style='background-color:#c4d2f5'>"+ "causal variant" + "</mark>" + " of " +"<span style='color:#4173f0;font-weight:bold'>"+ html.escape(str(mention2))+"</span>"  + ". " + "This piece of relation is evidenced by the sentence in PMID " + str(cre_sorted["pmid"]) + ': "'+cre_sorted["sentence"] + '" '
                sent30= "Based on the sentence (PMID: " + html.escape(str(cre_sorted["pmid"]))+") "+ ': "'+ html.escape(cre_sorted["sentence"]) + '" Our finding indicates that ' + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(str(mention1)) + "</span>"+ " is " +"<mark style='background-color:#c4d2f5'>"+ "associated with" + "</mark>"+ " " +"<span style='color:#4173f0;font-weight:bold'>"+ html.escape(str(mention2)) + "</span>" +" by " +"<mark style='background-color:#c4d2f5'>"+ "a confidence of "+'{}'.format(cre_sorted["annotation"][1])+ "." + "</mark>" + " "
            ...
            if cre_sorted["annotation"][0]=="In-patient":
                ...
                sent3= 'As claimed by "'+ cre_sorted["sentence"] +'" ' + '{}'.format(cre_sorted["annotation"][1])+ ""+ " sure that " + mention2+" patients show to have " + mention1 + ". "
                ## html
                sent10= "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention1)+ "</span>"  +" occurs in some " + "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention2) +"</span>"  +" patients." " Our finidng shows that the confidence of this association is approximately " + html.escape('{}'.format(cre_sorted["annotation"][1]))+". "+ "Here is an excerpt of the literature (PMID:" +str(cre_sorted["pmid"])+") " + 'that captures the relations: "' + html.escape(cre_sorted["sentence"]) +'" '
                sent20= "With a " +"<mark style='background-color:#c4d2f5'>"+ "confidence of " + html.escape('{}'.format(cre_sorted["annotation"][1]))+"</mark>" + ", we found that " +"<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention1)+"</span>" +" " + "<mark style='background-color:#c4d2f5'>"+ "patients "+ "carry" + "</mark>" + " " +"<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention2) +"."+"</mark>" +  "This piece of relation is evidenced by the sentence in PMID" + html.escape(str(cre_sorted["pmid"])) + ': "'+html.escape(cre_sorted["sentence"]) + '" '
                sent30= 'As claimed by "'+ html.escape(cre_sorted["sentence"]) +'" ' +"<mark style='background-color:#c4d2f5'>"+ html.escape('{}'.format(cre_sorted["annotation"][1]))+ " sure" +"</mark>" + " "  +"that" + " "+ "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention2)+"</span>" +" " + "<mark style='background-color:#c4d2f5'>"+ "patients show to have" +"</mark>" +" " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1) + "." + "</span>" + " "
            ...
            if cre_sorted["annotation"][0]=="Appositive":
                ...
                ## html
                sent10= "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1)+ "'s" + "</span>" +" relation with " + "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2) + "</span>" + "is" + "<mark style='background-color:#f7d2dc'>"+"presupposed." + "</mark>" +" We are " + "<mark style='background-color:#c4d2f5'>"+html.escape('{}'.format(cre_sorted["annotation"][1]))+ " " + "confident" +"</mark>"+ " about this association. " + "Here is an excerpt of the literature (PMID:" +html.escape(str(cre_sorted["pmid"]))+") " + 'that captures the relations: "' + html.escape(cre_sorted["sentence"]) +'" '
                sent20= "It is " + "<mark style='background-color:#c4d2f5'>"+ html.escape('{}'.format(cre_sorted["annotation"][1]))+" "+  "presupposed" + "</mark>" +" that "+ "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention1) +  "</span>"  +" is related to "+ "<span style='color:#4173f0;font-weight:bold'>" + html.escape(mention2) + "</span>" + ' as evidenced by "' + html.escape(cre_sorted["sentence"]) + "' (PMID: "+html.escape(str(cre_sorted["pmid"]))+'." '
                sent30= 'According to the sentence: "' + html.escape(cre_sorted["sentence"])+ "' (PMID: " + html.escape(str(cre_sorted["pmid"]))+") " + "The relation between " + "<span style='color:#4173f0;font-weight:bold'>"+ html.escape(mention1) + "</span>" +" and " +"<span style='color:#4173f0;font-weight:bold'>"+html.escape(mention2) +  "</span>" +" contains a " + "<mark style='background-color:#f7d2dc'>"+"presupposition." + "</mark>" + " "
            rbert_list=[sent1,sent2,sent3]
            rbert_list=random.choice(rbert_list)
            rbert_list2=[sent10,sent20,sent30]
            rbert_list2=random.choice(rbert_list2)
        if ore_sorted:
            if len(ore_sorted)==2:
               ...
               ## html
                sent10='Moreover, there are also other relations found in this PMID: ' + html.escape(target[4])+ ', which includes the following. ' + "<mark style='background-color:#f7d2dc'>" +'"' + html.escape(relation1) + '."' + "</mark>" + " " + "<mark style='background-color:#f7d2dc'>" +  '"' + html.escape(relation2)+ '."' + "</mark>" + " "
                sent20='Notably, in this PMID, further relations between these two entities are discovered. ' + "<mark style='background-color:#f7d2dc'>" + '"' + html.escape(relation1) + '."' + "</mark>" +"<mark style='background-color:#f7d2dc'>"+  '"' + html.escape(relation2)+ '."' + "</mark>" + " "
                sent30= 'PMID: ' + html.escape(target[4]) + ' also entails relations: '  + "<mark style='background-color:#f7d2dc'>"   + '"'+ html.escape(relation1) + '"' + "</mark>"  +" and " + "<mark style='background-color:#f7d2dc'>"  + html.escape(relation2) +'."'  + "</mark>" + " "
            else:
                if target[0] == "type_id_name" or target[0] == "type_name":
                    if target[1][2] in ore_sorted[0]["head"]:
                        mention1 = ore_sorted[0]["head"][2]
                ...
                ## html
                sent10='We also found'+"<mark style='background-color:#f7d2dc'>"+' "' + html.escape(' '.join(ore_sorted[0]["annotation"])) + '"'+ "." + "</mark>" + " "
                sent20="<mark style='background-color:#f7d2dc'>"+'"'+ ' '.join(ore_sorted[0]["annotation"]) + '"' + "." + "</mark>" + " "
                sent30="In addition, "+ "<mark style='background-color:#f7d2dc'>" +'"'+ html.escape(' '.join(ore_sorted[0]["annotation"])) + '"' + "." + "</mark>" + " "
