function post_run(){
    ...
    fetch("./run_umls_paper_search", {method: "post", body: JSON.stringify(request_data)})
...
function post_query(){
    ...
    fetch("./query_umls_paper_search", {method: "post", body: JSON.stringify(request_data)})
    .then(function(response){
        return response.json();
    })
    .then(function(response_data){
...
function get_query(){
    ...
    url = `./query_umls_paper_search?query=${query}`
