function run_query(){
    ...
    fetch("./run_mesh_chemical", {method: "post", body: JSON.stringify(request_data)})
...
function get_json(){
    ...
    url = `./query_mesh_chemical?query=${query}`
...
function post_json(){
    ...
    fetch("./query_mesh_chemical", {method: "post", body: JSON.stringify(request_data)})
    .then(function(response){
        return response.json();
    })
    .then(function(response_data){
