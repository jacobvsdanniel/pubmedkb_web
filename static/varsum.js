function run_query(){
    ...
    fetch("./run_varsum", {method: "post", body: JSON.stringify(request_data)})
...
function post_json(){
    ...
    fetch("./query_varsum", {method: "post", body: JSON.stringify(request_data)})
    .then(function(response){
        return response.json();
    })
    .then(function(response_data){
